        ...
        <Navbar>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mr-auto">
              <Nav.Link href="/masterlanding/landing">Home</Nav.Link>
              <Nav.Link href="/masterlanding/methods">Métodos</Nav.Link>
            ...
            <Row>
              <Col className="col-lg-6 h-100 text-center text-lg-left my-auto">
                <ul className = "list-inline mb-2">
                  <li className="list-inline-item"><Link href='/masterlanding/landing'><a>Home</a></Link></li>
                  <li className="list-inline-item">.</li>
                  <li className="list-inline-item"><Link href='/masterlanding/methods'><a>Currículo</a></Link></li>
                  <li className="list-inline-item">.</li>
